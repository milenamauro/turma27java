...
public class Postagem {
   ...
   private long id; //big int
	...
	@Size (min= 5, max=100) // anotação para a quantidade de caracter que o cliente consegue mandar como titulo
	private String titulo; //tipo o varchar (100)
	

		@NotNull //Anotacao para dizer que não pode ter titulo nulo
		// anotação para a quantidade de caracter que o cliente consegue mandar como titulo
		@Size (min= 10, max=500)
