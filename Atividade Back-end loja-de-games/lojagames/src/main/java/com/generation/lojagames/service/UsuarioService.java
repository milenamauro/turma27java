...
public class UsuarioService {
	...
	public Optional <Usuario> cadastrarUsuario(Usuario usuario){
		...
		int idade = Period.between(usuario.getDatadeNascimento(),LocalDate.now()).getYears();
		if(idade <18)
       ...
       public static Optional<UsuarioLogin> loginUsuario(Optional<UsuarioLogin> usuarioLogin) {
